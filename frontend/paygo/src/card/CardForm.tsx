 ...
 */
function CvvInput(props: {cardType: CardType, className?: string}) {
        ...
        <div>
            <div>
                ...
                <span className="block relative">
                    ...
                    <input type="text" placeholder="4111 1111 1111 1111" className={`mt-1 block pr-12 w-full rounded-sm rounded-t-lg shadow-sm ${border}`} onInput={props.onCardNumberChange} />
                </span>
            </div>
    ...
    return (
        <div className="w-96 m-auto">
            <form className="w-full space-y-2 text-gray-700">
                <CardInput {...state} onCardNumberChange={(event: FormEvent) => onCardNumberChange(event, setState)} />
